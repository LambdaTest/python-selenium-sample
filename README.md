...
- Follow the [Run Selenium tests with Python on TestMu AI](https://www.testmuai.com/support/docs/python-with-selenium-running-python-automation-scripts-on-testmu-selenium-grid/) for the full setup walkthrough.
